            ...
            steps {
                script {
                    if (env.BRANCH_NAME == 'dev') {
                        ...
                        env.IMAGE_URI    = "533267129063.dkr.ecr.us-east-1.amazonaws.com/nodejs-dev-repo"
                        env.SERVICE_NAME = 'nodejs-dev-service'
                    } else if (env.BRANCH_NAME == 'stage') {
                        env.IMAGE_NAME   = 'nodejs-stage-repo'
                        env.IMAGE_URI    = "533267129063.dkr.ecr.us-east-1.amazonaws.com/nodejs-stage-repo"
                        env.SERVICE_NAME = 'nodejs-stage-service'
                    } else if (env.BRANCH_NAME == 'prod') {
                        env.IMAGE_NAME   = 'nodejs-prod-repo'
                        env.IMAGE_URI    = "533267129063.dkr.ecr.us-east-1.amazonaws.com/nodejs-prod-repo"
